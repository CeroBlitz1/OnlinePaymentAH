<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="viewcustomerdetails.aspx.cs" Inherits="OnlinePaymentMode.viewcustomerdetails" %>
        ...
        <div class="col-md-6">
            <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered table-hover" HeaderStyle-BackColor="#cc6699"
                ...
                <Columns>
                    ...
                    <asp:ButtonField Text="VIEW " HeaderText="VIEW TRANSACTIONS" CommandName="select" ItemStyle-Width="150" HeaderStyle-BackColor="#00cc99" HeaderStyle-BorderColor="#009900" HeaderStyle-Font-Bold="true" HeaderStyle-Height="50px" />
